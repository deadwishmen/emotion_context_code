...
class Emotic_PreDataset(Dataset):
    ...
    def __init__(self, x_context, x_body, x_face, x_text, y_cat, y_cont, context_transform, body_transform, face_transform, context_norm, body_norm, face_norm):
...
def load_data(data_src, batch_size, 
    ...
    train_dataset = Emotic_PreDataset(train_context, train_body, train_face, train_text, train_cat, train_cont, train_transform, train_transform, face_train_transform, context_norm, body_norm, face_norm)
    val_dataset = Emotic_PreDataset(val_context, val_body, val_face, val_text, val_cat, val_cont, train_transform, train_transform, face_train_transform, context_norm, body_norm, face_norm)
    test_dataset = Emotic_PreDataset(test_context, test_body, test_face, test_text, test_cat, test_cont, test_transform, test_transform, face_test_transform, context_norm, body_norm, face_norm)
